...
//echo "".$rows."/rows/";
mysql_query("INSERT INTO mt_money VALUE('".$utc_chart."','".$money_code."','".$check_comment2."','".$date2."','".$date2."','','','".$id."')");
...
$y_data=substr("".$yearmoney_data."",-8,4)."-id".$id."";//=2017  //edit//
	...
	<div class="row">
		...
		<div class="col-lg-3 col-xs-6">
			<div class="small-box <?php print bg_color_modify(1);?>">
				...
				<a href="#" class="small-box-footer">
					สถานะ&nbsp;CPU&nbsp;<i class="fa fa-automobile"></i>
				</a>
			</div>
		</div>
		<!-- ./box1 col -->
		<div class="col-lg-3 col-xs-6">
			<div class="small-box <?php print bg_color_modify(2);?>">
				<div class="inner">
					<h3><span class="ap-online"><?php print count($neighbor_dash)." อุปกรณ์"; ?></span></h3>
				...
				<a href="javascript:popup('index.php?page=Access_Points_online')" class="small-box-footer">
					อุปกรณ์ปล่อยสัญญาณ&nbsp;<i class="fa fa-gamepad"></i>
				</a>
			</div>
		</div>
		<!-- ./box2 col -->
		<div class="col-lg-3 col-xs-6">
			<div class="small-box <?php print bg_color_modify(3);?>">
				<div class="inner">
					<h3><span class="user-online"><?php print  count($hotspot_dash)." คน"; ?></span></h3>
					<p>ผู้ใช้งานออนไลน์</p>
				</div>
				...
				<a href="javascript:popup('index.php?page=mikrotikuser')" class="small-box-footer">
					...
					print_r($ARRAY)?>&nbsp;User&nbsp;<i class="fa fa-graduation-cap"></i>
				</a>
			</div>
		</div>
		<!-- ./box3 col -->
		<div class="col-lg-3 col-xs-6">
			<div class="small-box <?php print bg_color_modify(4);?>">
				...
				<a href="javascript:popup('index.php?page=pppoe_mik_user')" class="small-box-footer">
					...
					print_r($ARRAY)?>&nbsp;User&nbsp;<i class="fa fa-group"></i>
				</a>
			</div>
		</div>
		<!-- ./box4 col -->
								...
								<div class="row">
									...
									<div class="col-md-6 col-xs-12">
										<div class="text-center">
											<h3><strong>Mikrotik Resources</strong></h3>
										</div><br><br>
										<div class="row">
									...
									<div class="col-md-6 col-xs-12">
										<div class="text-center">
											<h3><strong>Mikrotik Health</strong></h3>
										</div><br><br>
										<div class="row">
						...
						<div id="bookmarks" class="alist" style="display:none;">
							<div class="chart">
								<div class="row">
									<div class="col-md-6 col-xs-12">
										<div class="text-center">
											<h3><strong>Hotspot Bookmarks</strong></h3>
										</div>
										<div class="row">
															...
															<div class="col-md-4 col-xs-12">
																<a href="index.php?page=useronline" class="btn btn-app">
																	...
																	<a href="index.php?page=money_month" class="btn btn-app">
																		...
																		<div class="col-md-6 col-xs-12">
																			<div class="text-center">
																				<h3><strong>PPPOE Bookmarks</strong></h3>
																			</div>
																			<div class="row">
																				<div class="col-md-4 col-xs-12">
																					...
																					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
																						<div class="info-box <?php print bg_color_modify(8);?>">
																							...
																							<div class="info-box-content">
																								...
																								<span class="date"> <?php print "".($clock_dash['0']['date']);?></span>
																								<span class="time"> <?php print "".($clock_dash['0']['time']);?>
																								</span>
																							</div>
																						</div>
																					</div>
																								...
																								<div class="info-box">
																									<span class="info-box-icon <?php print bg_color_modify(11);?>">
																										...
																										<div class="info-box-content">
																											...
																											<span class="info-box-text">
																												<b><?php $ARRAY = $API->comm("/ip/dhcp-server/lease/print", array(
																																		"count-only"=> "",
																																		"~active-address" => "1.1.",
																																	));
																											print_r($ARRAY)?></b></span>
																										</div>
																									</div>
																								</div>
																								<!-- ./col info-box2-->
																									...
																									<div class="info-box">
																										<span class="info-box-icon <?php print bg_color_modify(12);?>">
																											...
																											<div class="info-box-content">
																												...
																												<span class="info-box-text">
																													<b><?php $ARRAY = $API->comm("/interface/print", array(
																																									"count-only"=> "",));
																												echo($ARRAY)?></b></span>
																											</div>
																										</div>
