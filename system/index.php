...
?>
    ...
    <head>
        ...
        <!--+++++++  คำสั่งเรียกใช้ ภาพ ของ icon แสดงบน title bar ++++++++-->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="../img/manpro.png" class="user-image" alt="User Image">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-header">
                                        ...
                                        <p>
                                            ...
                                            <?php echo ($_SESSION['EmpUser']); ?> - ROCKET API
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="#" target="_blank" class="btn btn-black ">แท๊ปใหม่</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="../admin/logout.php" class="btn btn-black ">ออกจากระบบ</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href="index.php">
                            <i class="fa fa-rocket text-yellow"></i> <span>หน้าหลัก</span>
                            <span class="label label-primary pull-right"></span></a>
                        </li>
                        <li class="treeview">
                            <a href="index.php?page=useronline">
                                <i class="fa fa-group text-green"></i>
                                <span>ผู้ใช้งานออนไลน์</span>
                                <span class="label label-primary pull-right"></span>
                                <small class="label pull-right bg-yellow"><?php $ARRAY = $API->comm("/ip/hotspot/active/print", array(
                                "count-only"=> "",
                                "~active-address" => "1.1.",
                                ));
                                print_r($ARRAY)?></small>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-wifi text-blue"></i><span>&nbsp;Hotspot</span>
                                <span class="label label-primary pull-right"></span>
                                <small class="label pull-right bg-blue"><?php $ARRAY = $API->comm("/ip/hotspot/user/print", array(
                                "count-only"=> "",
                                "~active-address" => "1.1.",
                                ));
                                print_r($ARRAY)?></small>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-check-square-o"></i>โปรไฟล์</a>
                                    <ul class="treeview-menu">
                                        <li><a href="#"><i class="fa fa-check-square-o"></i>เพิ่มโปรไฟล์</a>
                                            <ul class="treeview-menu">
                                                <li><a href="index.php?page=add_profile"><i class="fa fa-check"></i>เพิ่มโปรไฟล์</a></li>
                                                <li><a href="index.php?page=add_macprofile"><i class="fa fa-check"></i>เพิ่มโปรไฟล์&nbsp;Lock&nbsp;Mac</a></li>
                                                <!--<li><a href="index.php?page=add_usermanager_profile"><i class="fa fa-check"></i>เพิ่มโปรไฟล์ Userman</a></li>-->
                                            </ul>
                                        </li>
                                        <li><a href="index.php?page=profilelist"><i class="fa fa-check"></i>รายชื่อโปรไฟล์</a></li>
                                    </ul>
                                </li>
                                <li><a href="#"><i class="fa fa-check-square-o"></i>ผู้ใช้งาน</a>
                                    <ul class="treeview-menu">
                                        <li><a href="#"><i class="fa fa-check-square-o"></i>เพิ่มผู้ใช้งาน</a>
                                            <ul class="treeview-menu">
                                                <li><a href="index.php?page=manuser"><i class="fa fa-check"></i>เพิ่มผู้ใช้งาน</a></li>
                                                <li><a href="index.php?page=genuser"><i class="fa fa-check"></i>เพิ่มผู้ใช้งานแบบกลุ่ม</a></li>
                                                <!--<li><a href="index.php?page=add_usermanager"><i class="fa fa-check"></i>Add&nbsp;UserManager</a></li>-->
                                                <!--<li><a href="index.php?page=gen_usermanager"><i class="fa fa-check"></i>Gen&nbsp;UserManager</a></li>-->
                                            </ul>
                                        </li>
                                        <li><a href="index.php?page=listuser"><i class="fa fa-check"></i>บัตรคูปอง</a></li>
                                        <li><a href="index.php?page=mikrotikuser"><i class="fa fa-check"></i>รายชื่อผู้ใช้งาน</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-check-square-o"></i>อื่นๆ</a>
                                    <ul class="treeview-menu">
                                        <li><a href="index.php?page=hostonline"><i class="fa fa-check"></i>Host&nbsp;Connect</a></li>
                                        <li><a href="index.php?page=script_hotspot"><i class="fa fa-check"></i>Script&nbsp;Expire&nbsp;User</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-user-secret text-red"></i><span>&nbsp;User Manager</span>
                                <span class="label label-primary pull-right"></span>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-check-square-o"></i>โปรไฟล์</a>
                                    <ul class="treeview-menu">
                                        <li><a href="index.php?page=add_usermanager_profile"><i class="fa fa-check"></i>เพิ่มโปรไฟล์</a></li>
                                        <li><a href="index.php?page=usermanager"><i class="fa fa-check"></i>รายชื่อโปรไฟล์</a></li>
                                    </ul>
                                </li>
                                <li><a href="#"><i class="fa fa-check-square-o"></i>ผู้ใช้งาน</a>
                                    <ul class="treeview-menu">
                                        ...
                                        <li><a href="index.php?page=usermanager"><i class="fa fa-check"></i>รายชื่อผู้ใช้งาน</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
        <i class="fa fa-sliders text-green"></i><span>&nbsp;PPPoE</span>
        <span class="label label-primary pull-right"></span>
        <small class="label pull-right bg-red"><?php $ARRAY = $API->comm("/ppp/secret/print", array(
																								"count-only"=> "",
																								"~active-address" => "1.1.",
																							));
					print_r($ARRAY)?></small>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-check-square-o"></i>โปรไฟล์</a>
                                    <ul class="treeview-menu">
                                        <li><a href="index.php?page=add_pppoe_profile"><i class="fa fa-check"></i>&nbsp;เพิ่มโปรไฟล์</a></li>
                                        <li><a href="index.php?page=pppoe_profile_list"><i class="fa fa-check"></i>&nbsp;รายชื่อโปรไฟล์</a></li>
                                    </ul>
                                </li>
                                <li><a href="#"><i class="fa fa-check-square-o"></i>ผู้ใช้งาน</a>
                                    <ul class="treeview-menu">
                                        <li><a href="#"><i class="fa fa-check-square-o"></i>เพิ่มผู้ใช้งาน</a>
                                            <ul class="treeview-menu">
                                                <li><a href="index.php?page=add_pppoe"><i class="fa fa-check"></i>เพิ่มผู้ใช้งาน</a></li>
                                                <li><a href="index.php?page=gen_pppoe"><i class="fa fa-check"></i>เพิ่มผู้ใช้งานแบบกลุ่ม</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="#"><i class="fa fa-check-square-o"></i>รายชื่อผู้ใช้งาน</a>
                                            <ul class="treeview-menu">
                                                <li><a href="index.php?page=pppoe_dtb_user"><i class="fa fa-check"></i>Databases&nbsp;User</a></li>
                                                <li><a href="index.php?page=pppoe_mik_user"><i class="fa fa-check"></i>Mikrotik&nbsp;User</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="#"><i class="fa fa-check-square-o"></i>อื่นๆ</a>
                                    <ul class="treeview-menu">
                                        <li><a href="index.php?page=pppoe_online"><i class="fa fa-check"></i>PPPoE&nbsp;ออนไลน์</a></li>
                                        <li><a href="index.php?page=script_pppoe"><i class="fa fa-check"></i>Script&nbsp;Expire&nbsp;User</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-file-code-o text-aqua"></i><span>&nbsp;Import&Export</span>
<span class="label label-primary pull-right"></span>
<small class="label pull-right bg-green">new</small>
</a>
                            <ul class="treeview-menu">
                                <li><a href="index.php?page=Import_Exel"><i class="fa fa-check"></i>Import&nbsp;Hotspot&nbsp;User  </a></li>
                                <li><a href="index.php?page=pppoe_Import_Exel"><i class="fa fa-check"></i>Import&nbsp;PPPOE&nbsp;User</a> </li>
                                <li><a href="index.php?page=import_usermanager"><i class="fa fa-check"></i>Import&nbsp;User&nbsp;Manager </a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#"><i class="fa fa-cc-visa text-yellow"></i><span>&nbsp;Money</span> <span class="label label-primary pull-right"></span>  </a>
                            <ul class="treeview-menu">
                                <li><a href="index.php?page=total_money"><i class="fa fa-check"></i>Hotspot&nbsp;Money</a></li>
                                <li><a href="index.php?page=pppoe_total_money"><i class="fa fa-check"></i>PPPoE&nbsp;Money</a> </li>
                            </ul>
                        </li>
                        <li class="treeview">
...
<span class="label label-primary pull-right"></span>
<small class="label pull-right bg-red"><?php $ARRAY = $API->comm("/ip/neighbor/print", array(
                                "count-only"=> "",
                                "~active-address" => "1.1.",
                                ));
                                print_r($ARRAY)?></small>
