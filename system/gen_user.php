            ...
            <div class="col-lg-12">
                ...
                <div class="<?php print panel_modify();?>">
                    <div class="<?php print $panel_heading;?>">
                        <strong><i class="fa fa-users"></i>&nbsp;เพิ่มผู้ใช้งาน</strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input name="max_user" type="text" placeholder="จำนวนuserที่ต้องการสร้าง" value="10" maxlength="5" required class="form-control">
                                    </div>
                                </div>
                            </div>
				...
				$text_success="<i class=\"fa fa-check\"></i>&nbsp;เพิ่มผู้ใช้งาน";
