<?php
			...
			include_once('../include/convert.php');
				...
				if(!empty($_REQUEST['profile'])){
	                   ...
	                   mysql_query("UPDATE pppoe_pro SET package_name='".$package_name."',card_name='".$card_name."', data_limit='".$data_limit."', time_limit='".$time_limit."', vat='".$vat."', phone='".$phone."', server_ip='".$server_ip."', color='".$color."' WHERE pro_name='".$pro_name."'");
