<?php
	...
	echo "<script language='javascript'>swal({
                    title: 'คุณแน่ใจไหม?',
                    text: 'ต้องการจะแก้ไข user ".$rows." จำนวน ใช่หรือไม่',
                    type: 'warning',
    ...
    <section class="content">
        ...
        <form name="name" action="" method="post">
            <div class="<?php print panel_modify();?>">
                <div class="<?php print $panel_heading;?>"><i class="fa fa-user"></i>
                    <strong> PPPoE Mikrotik User </strong>
			...
			#######################################################################################
                    ...
                    title: 'คุณแน่ใจไหม?',
                    text: 'ต้องการจะเตะ  ".$ARRAY[$i]['name']."  ใช่หรือไม่',
                    type: 'warning',
					//allowOutsideClick: false,
					//showCloseButton: true,
					 showCancelButton: true,
        ...
        ######################################################################################
				...
				$onclick_del="onclick=\"swal({
                    title: 'คุณแน่ใจไหม?',
                    text: 'ต้องการจะลบ  ".$ARRAY[$i]['name']."  ใช่หรือไม่',
                    type: 'warning',
					//allowOutsideClick: false,
					//showCloseButton: true,
					 showCancelButton: true,
