                ...
                <div class="col-lg-12">
                    <div class="<?php print panel_modify();?>">
                        <div class="<?php print $panel_heading;?>"><i class="fa fa-user"></i>
                            <strong> PPPoE All Database User</strong>
                            <?php print $date_time_show;?>
                        </div>
                        <div class="panel-body">
                            <span style="color:#ffffff;
float: left;
"><a href="index.php?page=pppoe_dtb_user" class="btn btn-default fa fa-arrow-left"></a>&nbsp;<a href="index.php?page=pppoe_all_data_users&id=<?php echo $_GET['id']; ?>" class="btn btn-default fa fa-rotate-right"></a> </span>
                            <?php  echo "<span class=\"\">";           
