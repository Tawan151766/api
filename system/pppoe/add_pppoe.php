...
`<div class="col-lg-12" >
             <div class="<?php print panel_modify();?>">
                <div class="<?php print $panel_heading;?>" >
                    <i class="fa fa-user"></i>&nbsp;&nbsp;<strong>PPPoE Add User</strong> <?php print $date_time_show;?> </div>                    
               ...
               echo button_btn_submit_account($account,$text_success,$bottonbtn_success);
				                  ...
				                  ?>
								<button  class="btn btn-danger" type="reset">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh"></i>&nbsp;รีเซ็ต&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;&nbsp;<span class="hidden-xs"><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#manual">ข้อแนะนำการใช้งาน </button></span>
