...
<section class="content"> 
         ...
         <div class="col-lg-12" >
			...
			echo button_btn_xs_account($account,$onclick_csv,'','','','','','','',$xs_export);
							...
							<?php
							echo "<a class=\"btn btn-success \"  title= \"click to view\" href='index.php?page=pppoe_all_data_users&id=".$id."'><span class=\"fa fa-list\"></span> ผู้ใช้งานทั้งหมด </a>&nbsp;&nbsp;&nbsp;<a class=\"btn btn-warning \"  title= \"click to  view Card\" href='index.php?page=pppoe_card'><span class=\"fa fa-credit-card\"></span>   ดูบัตรคูปอง  </a>&nbsp;&nbsp;&nbsp;";
