            ...
            <div class="<?php print panel_modify();?>">
               ...
               echo "<button class=\"btn btn-default btn-xs\" title= \"".$TA."".$TD."".$TH."".$TP."".$TS."\" data-toggle=\"tooltip\"  <span></span>".$A."".$D."".$H."".$P."".$S."</button>&nbsp;&nbsp;";
				...
				if($account!="read"){
                    ...
                    title: 'คุณแน่ใจไหม?',
                    text: 'ต้องการจะKick  ".$ARRAY[$i]['to-address']."  ใช่หรือไม่',
                    type: 'warning',
					...
					<span class=\"glyphicon glyphicon-remove\" ></span> เตะ</a></td>";
				}else{
					echo  "<a class=\"btn btn-danger btn-xs\"  title= \"เตะโฮส \"><span class=\"glyphicon glyphicon-remove\" ></span> Kick</a></td>";
...
?>
                    ...
                    <div class="form-group input-group">
                        ...
                        <?php
	 if($account!="read"){
	 echo "<button  value=\"remove\" data-toggle=\"tooltip\" title= \"select to kick host online\" name=\"active\" class=\"btn btn-danger\" type=\"submit\"><i class=\"fa fa-times\"></i>&nbsp;ลบ&nbsp;</button>";
	 }else{
	 echo "<a  value=\"remove\" title= \"select to kick host online\" name=\"active\" class=\"btn btn-danger\" type=\"submit\"><i class=\"fa fa-times\"></i>&nbsp;ลบ&nbsp;</a>";
	 }
				                       ?>
                    </div>
                </div>
