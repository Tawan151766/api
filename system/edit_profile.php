<?php
	...
	$price=$_REQUEST['price'];
		...
		$ARRAY = $API->comm("/ip/hotspot/user/profile/set", array(
						...
						echo "<script language='javascript'>swal('บันทึกสำเร็จ!','แก้ไข  ".$profile." สำเร็จแล้ว','success').then(function () {
    ...
    window.location.href = 'index.php?page=profilelist';}})</script>";
							...
							echo "<script language='javascript'>swal('ขออภัยค่ะ! ".$_REQUEST['pro_name']."','มีชื่อ ".$_REQUEST['pro_name']." แล้วในฐานข้อมูล กรุณาตั้งชื่อใหม่','error').then(function () {}, function (dismiss) {if (dismiss === 'overlay') {}})</script>";
						}
					}
				}
            ...
            <div class="col-lg-12">
                <div class="<?php print panel_modify();?>">
                    <div class="<?php print $panel_heading;?>">
                        <i class="fa fa-folder-open"></i>&nbsp;<strong>แก้ไขโปรไฟล์</strong>
                    </div>
					...
					?>
                                        <div class="form-group">
                                            <span class=" style1">Price <img src="../img/help.png" width="16" height="16"  class="no1" data-toggle="tooltip" data-placement="right" title="กำหนดราคาของ profile"></span>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        <span class=" style1">Keepalive Timeout <img src="../img/help.png" width="16" height="16"  class="no1" data-toggle="tooltip" data-placement="right" title="กำหนดเวลา logout user ออกจากระบบถ้าไม่ได้เชื่อมใช้งาน"></span>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        <span class="style1">Shared Users<img src="../img/help.png" width="16" height="16"  class="no2" data-toggle="tooltip" data-placement="right" title="กำหนดจำนวนเครื่องที่สามารถใช้พร้อมกันได้ ต่อ 1 user"></span>
               ...
               echo button_btn_submit_account($account,$text_success,$bottonbtn_success);
				?>
                                        ...
                                        <button id="btnCancel" class="btn btn-danger" type="reset" Onclick="window.location.href = 'index.php?page=profilelist'">&nbsp;&nbsp;&nbsp;<i class="fa fa-times"></i>&nbsp;ยกเลิก&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;
