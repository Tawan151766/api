         ...
         <div class="col-lg-12" >
            <div class="<?php print panel_modify();?>">
                <div class="<?php print $panel_heading;?>" >
                    <strong><i class="fa fa-user"></i>&nbsp;แก้ไขผู้ใช้งาน</strong>
					 ...
					 <div class="row">
                       ...
                       <div class="col-xs-12  col-md-6">
						...
						<div class="col-lg-12 col-md-12 " >                                    
                                       <?php
						if($account!="read"){
                    echo "<button id=\"btnSave\" class=\"btn btn-success\" type=\"submit\">&nbsp;&nbsp;&nbsp;<i class=\"fa fa-check\"></i>&nbsp;บันทึก&nbsp;&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;&nbsp;<button id=\"btnCancel\" class=\"btn btn-danger\" type=\"reset\"  Onclick=\"javascript:history.back()\">&nbsp;&nbsp;&nbsp;&nbsp;<i class=\"fa fa-times\"></i>&nbsp;ยกเลิก&nbsp;&nbsp;&nbsp;&nbsp;</button> ";
					}else{echo "<a id=\"btnSave\" class=\"btn btn-success\" type=\"submit\">&nbsp;&nbsp;<i class=\"fa fa-check\"></i>&nbsp;บันทึก&nbsp;&nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;<button id=\"btnCancel\" class=\"btn btn-danger\" type=\"reset\"  Onclick=\"javascript:history.back()\">&nbsp;&nbsp;&nbsp;<i class=\"fa fa-times\"></i>&nbsp;ยกเลิก&nbsp;&nbsp;&nbsp;&nbsp;</button> ";
								   }
				?>
                        &nbsp;&nbsp;<span class="hidden-xs"><button id="btnSave" class="btn btn-warning" type="reset">&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh"></i>&nbsp;รีเซ็ต&nbsp;&nbsp;&nbsp;</button></span>
                            </div> 
                        </div>
                    </form>
                </div>
