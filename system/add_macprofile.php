...
<div class="col-lg-12" >
            ...
            <div class="<?php print panel_modify();?>">
                <div class="<?php print $panel_heading;?>" >
                    <strong><i class="fa fa-folder-open"></i>&nbsp;เพิ่มโปรไฟล์ Lock Mac Address</strong><?php print $date_time_show;?></div>    
						...
						<div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input name="keep" type="text" placeholder="Ex.00:02:00" class="form-control" value="01:00:00" >
                               </div>
                            </div>
							<div class="col-xs-12 col-md-6">
                                <div class="form-group">
               ...
               echo button_btn_submit_account($account,$text_success,$bottonbtn_success);
				?>
								<button id="btnSave" class="btn btn-danger" type="reset">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-refresh"></i>&nbsp;ยกเลิก&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
								 &nbsp;&nbsp;&nbsp;<span class="hidden-xs"><button type="button" class="btn btn-info" data-toggle="collapse" data-target="#manual">ข้อแนะนำการใช้งาน</button></span>
                            </div>
						</div>
						</div>
