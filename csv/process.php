                ...
                <tbody>
                    <tr>
                            ...
                            <table class="kangndo" style="background-color:#FFFFFF; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; width: 100%; margin-right: auto; margin-left: auto;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 50%; text-align: center;">
                                            <?php print $pro[home_page];?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%; text-align: center;">Time Limit</td>
                                        <td style="width: 50%; text-align: center;">
                                            <?php print $pro[time_limit];?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 50%; text-align: center;">Price</td>
                                        <td style="width: 50%; text-align: center;">ราคา.&nbsp;
                                            <?php print ($pro[pro_price]+$pro[vat]);?>&nbsp;บาท</td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <td style="background-color:#FFFFFF; width: 10px; text-align: center;">
                            <div align="center" class="qrcode" id="<?php print $objArr[0];?>">
                                <font color="red"><br><br><span class="style3"><font color="red"><span class="style3">SCAN LOG IN</span><br>
                                </font>
                                </span>
                                <script>
                                    jQuery(function() {
                                        jQuery('#<?php print $objArr[0];?>').qrcode({
                                            "render": 'div',
                                            "size": 80,
                                            "minVersion": 5,
                                            "maxVersion": 5,
                                            "ecLevel": 'L',
                                            "mode": 0,
                                            "text": "http://<?php print $pro[server_ip];?>/login?username=<?php print $objArr[0];?>&password=<?php print $objArr[1];?>",
                                            "quiet": 0,
                                        });
                                    })
