...
echo "<tbody>";
echo "<tr>";
echo "<td style=\"width: 190px; text-align: center;\"><span style=\"font-weight: bold; color: rgb(255, 255, 255); font-size: 11px; font-family: Prompt;\">".$pro[card_name]."</span><br>
...
echo "<tbody>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\">แพ๊กเกจ</td>";
echo "<td style=\"width: 50%; text-align: center;\">".$pro[package_name]."</td>";
echo "</tr>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\">โฮมเพจ</td>";
echo "<td style=\"width: 50%; text-align: center;\">".$pro[home_page]."</td>";
echo "</tr>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\">เวลาใช้งาน</td>";
echo "<td style=\"width: 50%; text-align: center;\">".$pro[time_limit]."</td>";
echo "</tr>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\">ราคา</td>";
echo "<td style=\"width: 50%; text-align: center;\">".($pro[pro_price]+$pro[vat])."&nbsp;บาท</td>";
echo "</tr>";
echo "</tbody>";
echo "</table>";
...
echo "<tbody>";
echo "<tr>";
echo "<td style=\"width: 50%; text-align: center;\"><span class=\"style4\"style=\"color: rgb(255, 255, 255); font-family: Prompt;\">Username</span></td>";
echo "<td style=\"width: 50%; text-align: center;\"><span class=\"style4\"style=\"color: rgb(255, 255, 255); font-family: Prompt;\">Password</span></td>";
echo "</tr>";
 echo "<tr width: 50%>";
echo "<td style=\"background-color:#FFFFFF; width: 50%; text-align: center;\"><span style=\"color: #400000; font-size:16px; font-family:  Prompt;\">".$result[user]."</span></td>";
echo "<td style=\"background-color:#FFFFFF; width: 50%; text-align: center;\"><span style=\"color: #400000; font-size:16px; font-family: Prompt;\">".$result[pass]."</span></td>";
echo "</tr>";
echo "</tbody>";
echo "</table>";
echo "<table class=\"kangndo\" style=\"border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; width: 100%; margin-right: auto; margin-left: auto;\">";
echo "<tbody>";
echo "<tr>";
echo "<td style=\"width: 60%; text-align: center;\"><span style=\"color: rgb(255, 255, 255); font-family: Prompt;\">มีปัญหาการใช้งานติดต่อ : ".$pro[phone]." </span></td>";
echo "</tr>";
echo "</table>";
echo "</td>";
