...
?>
    <section class="content">
        ...
        <div class="<?php print panel_modify();?>">
            <div class="<?php print $panel_heading;?>"><strong>แก้ไข&nbsp;Mikrotik</strong>
            </div>
            <div class="modal-body">
                <div class="row">
				  ...
				  <a href="#"  data-toggle="modal" data-target="#PINDetail" data-toggle="tooltip" data-placement="top" title="ดูรายละเอียด"><i class="fa fa-circle" style="color: #ff1c15"> </i></a></label>
                                                ...
                                                <option type="text" class="form-control" id="userPin" name="userPin" title="Please enter your Site PIN" placeholder="Ex.12345678" value="" required>
                                                    <?php echo $result[user_pin];?>
                                                </option>
                                            </div>
                                        </div>
