  ...
  $settotal_remove="".$scr_remno1."".$scr_remno2."".$scr_remno3."".$scr_remno4."".$scr_remno5."".$scr_remno6."".$scr_remno7."".$scr_remno8."".$scr_remno9."".$scr_remno10."".$scr_remno11."".$scr_remno12."".$scr_remno13."".$scr_remno14."".$scr_remno15."".$scr_remno16."".$scr_remno17."".$scr_remno18."".$scr_remno19."".$scr_remno20."".$end20."".$end19."".$end18."".$end17."".$end16."".$end15."".$end14."".$end13."".$end12."".$end11."".$end10."".$end9."".$end8."".$end7."".$end6."".$end5."".$end4."".$end3."".$end2."";
    ...
    window.history.back();
		...
		for($i=0; $i<$num; $i++){
			...
			if($error != ""){
				echo "<script language='javascript'>swal('เกิดข้อผิดพลาด!','มีชื่อ ".$error." แล้วใน scheduler กรุณาลบหรือตั้งชื่อใหม่','error').then(function () {
               window.history.back();}, function (dismiss) {
             if (dismiss === 'overlay') {
    window.history.back();
   }})</script>";
...
mysql_query("UPDATE mt_profile SET pro_expire='".$expirepro_no20."'WHERE pro_name='".$pro_no20."'");
			...
			echo "<script language='javascript'>swal('เพิ่มสคริปสำเร็จแล้ว!','1.".$expire_name." 2.".$disable_name." 3.".$remove_name." สำเร็จแล้ว','success').then(function () {
