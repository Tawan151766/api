...
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no11."'WHERE pro_name='".$pro_no11."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no12."'WHERE pro_name='".$pro_no12."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no13."'WHERE pro_name='".$pro_no13."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no14."'WHERE pro_name='".$pro_no14."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no15."'WHERE pro_name='".$pro_no15."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no16."'WHERE pro_name='".$pro_no16."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no17."'WHERE pro_name='".$pro_no17."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no18."'WHERE pro_name='".$pro_no18."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no19."'WHERE pro_name='".$pro_no19."'");
mysql_query("UPDATE pppoe_pro SET pro_expire='".$expirepro_no20."'WHERE pro_name='".$pro_no20."'");
